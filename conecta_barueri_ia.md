...
📌 Prompt para iniciar o chat:
    "Estou anexando o arquivo PROJECT_DOCUMENTATION.md que contém o PDD (Documento de Descrição do Projeto) do meu sistema, o Conecta Barueri. Ele detalha toda a estrutura MVC em Flask, as regras de negócio de UI/UX em Light Mode e os padrões de banco de dados.

    Leia e memorize este arquivo. Não gere nenhum código ainda. Apenas me confirme que entendeu a estrutura e se coloque à disposição para as tarefas."

Depois que a IA responder confirmando que entendeu, aí sim você pede a tarefa específica (ex: "Com base no PDD, crie a rota de login no arquivo auth.py...").
